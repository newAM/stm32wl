...
pub use CALRAF_AW as CSSRUF_AW;
#[doc = "Clear internal timestamp flag"]
pub use CALRAF_AW as CITSF_AW;
#[doc = "Clear timestamp overflow flag"]
pub use CALRAF_AW as CTSOVF_AW;
#[doc = "Clear timestamp flag"]
pub use CALRAF_AW as CTSF_AW;
#[doc = "Clear wakeup timer flag"]
pub use CALRAF_AW as CWUTF_AW;
#[doc = "Clear alarm B flag"]
pub use CALRAF_AW as CALRBF_AW;
