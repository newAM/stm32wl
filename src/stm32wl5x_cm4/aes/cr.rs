...
pub type ERRC_R = crate::BitReader<ERRC_A>;
impl ERRC_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
...
pub type ERRC_W<'a, const O: u8> = crate::BitWriter<'a, u32, CR_SPEC, ERRC_A, O>;
...
pub type CCFC_R = crate::BitReader<CCFC_A>;
impl CCFC_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
...
pub type CCFC_W<'a, const O: u8> = crate::BitWriter<'a, u32, CR_SPEC, CCFC_A, O>;
