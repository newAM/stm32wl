...
///Field `UIFCPYorRes` reader - UIF Copy
pub struct UIFCPYORRES_R(crate::FieldReader<bool, bool>);
impl UIFCPYORRES_R {
    pub(crate) fn new(bits: bool) -> Self {
        UIFCPYORRES_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for UIFCPYORRES_R {
