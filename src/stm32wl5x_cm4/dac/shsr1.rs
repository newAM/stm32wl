...
///Field `TSAMPLE1` reader - DAC Channel 1 sample Time (only valid in Sample and Hold mode)
...
///Field `TSAMPLE1` writer - DAC Channel 1 sample Time (only valid in Sample and Hold mode)
