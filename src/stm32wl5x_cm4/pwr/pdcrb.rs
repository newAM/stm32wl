...
///Field `PD15` reader - Port PB\[y\]
///pull-down (y=5 to 15)
pub type PD15_R = PD10_R;
///Field `PD15` writer - Port PB\[y\]
///pull-down (y=5 to 15)
pub struct PD15_W<'a> {
    w: &'a mut W,
}
...
///Field `PD12` reader - PD12
pub type PD12_R = PD10_R;
///Field `PD12` writer - PD12
pub struct PD12_W<'a> {
    w: &'a mut W,
}
impl<'a> PD12_W<'a> {
...
pub enum PD10_A {
    ///0: Disable the pull-down on PB\[y\]
    ///when both APC bits are set in PWR control register 3 (PWR_CR3)
    DISABLED = 0,
    ///1: Enable the pull-down on PB\[y\]
    ///when both APC bits are set in PWR control register 3 (PWR_CR3)
    ENABLED = 1,
}
...
///Field `PD3` reader - Port PB\[y\]
///pull-down (y=0 to 3)
pub type PD3_R = PD0_R;
///Field `PD3` writer - Port PB\[y\]
///pull-down (y=0 to 3)
pub struct PD3_W<'a> {
    w: &'a mut W,
}
