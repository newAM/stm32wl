...
pub type OC2M_3_A = OC1M_3_A;
///Field `OC2M_3` reader - Output Compare 2 mode - bit 3
pub type OC2M_3_R = OC1M_3_R;
...
pub struct OC1M_3_R(crate::FieldReader<bool, OC1M_3_A>);
impl OC1M_3_R {
...
impl core::ops::Deref for OC1M_3_R {
    type Target = crate::FieldReader<bool, OC1M_3_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl<'a> OC1M_3_W<'a> {
    ///Writes `variant` to the field
    #[inline(always)]
    pub fn variant(self, variant: OC1M_3_A) -> &'a mut W {
        self.bit(variant.into())
    }
    ///Normal output compare mode (modes 0-7)
    #[inline(always)]
...
pub type OC2CE_A = OC1CE_A;
///Field `OC2CE` reader - Output compare 2 clear enable
pub type OC2CE_R = OC1CE_R;
...
pub type OC2FE_A = OC1FE_A;
///Field `OC2FE` reader - Output compare 2 fast enable
pub type OC2FE_R = OC1FE_R;
...
impl<'a> OC2FE_W<'a> {
    ///Writes `variant` to the field
    #[inline(always)]
    pub fn variant(self, variant: OC2FE_A) -> &'a mut W {
        self.bit(variant.into())
    }
    ///Fast output disabled
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
        self.variant(OC2FE_A::DISABLED)
    }
    ///Fast output enabled
    #[inline(always)]
    pub fn enabled(self) -> &'a mut W {
        self.variant(OC2FE_A::ENABLED)
    }
    ///Sets the field bit
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
