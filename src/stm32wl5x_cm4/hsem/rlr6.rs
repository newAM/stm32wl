///Register `RLR6` reader
pub struct R(crate::R<RLR6_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RLR6_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RLR6_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RLR6_SPEC>) -> Self {
        R(reader)
    }
}
...
///
///For information about available fields see [rlr6](index.html) module
pub struct RLR6_SPEC;
impl crate::RegisterSpec for RLR6_SPEC {
    type Ux = u32;
}
///`read()` method returns [rlr6::R](R) reader structure
impl crate::Readable for RLR6_SPEC {
    type Reader = R;
}
///`reset()` method sets RLR6 to value 0
impl crate::Resettable for RLR6_SPEC {
    #[inline(always)]
