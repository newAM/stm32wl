///Register `RLR8` reader
pub struct R(crate::R<RLR8_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RLR8_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RLR8_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RLR8_SPEC>) -> Self {
        R(reader)
    }
}
...
///
///For information about available fields see [rlr8](index.html) module
pub struct RLR8_SPEC;
impl crate::RegisterSpec for RLR8_SPEC {
    type Ux = u32;
}
///`read()` method returns [rlr8::R](R) reader structure
impl crate::Readable for RLR8_SPEC {
    type Reader = R;
}
///`reset()` method sets RLR8 to value 0
impl crate::Resettable for RLR8_SPEC {
    #[inline(always)]
