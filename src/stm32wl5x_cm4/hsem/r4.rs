///Register `R4` reader
pub struct R(crate::R<R4_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<R4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<R4_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<R4_SPEC>) -> Self {
        R(reader)
    }
}
///Register `R4` writer
pub struct W(crate::W<R4_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<R4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<R4_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<R4_SPEC>) -> Self {
        W(writer)
    }
}
...
///
///For information about available fields see [r4](index.html) module
pub struct R4_SPEC;
impl crate::RegisterSpec for R4_SPEC {
    type Ux = u32;
}
///`read()` method returns [r4::R](R) reader structure
impl crate::Readable for R4_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [r4::W](W) writer structure
impl crate::Writable for R4_SPEC {
    type Writer = W;
}
///`reset()` method sets R4 to value 0
impl crate::Resettable for R4_SPEC {
    #[inline(always)]
