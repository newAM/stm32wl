///Register `RLR7` reader
pub struct R(crate::R<RLR7_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RLR7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RLR7_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RLR7_SPEC>) -> Self {
        R(reader)
    }
}
...
///
///For information about available fields see [rlr7](index.html) module
pub struct RLR7_SPEC;
impl crate::RegisterSpec for RLR7_SPEC {
    type Ux = u32;
}
///`read()` method returns [rlr7::R](R) reader structure
impl crate::Readable for RLR7_SPEC {
    type Reader = R;
}
///`reset()` method sets RLR7 to value 0
impl crate::Resettable for RLR7_SPEC {
    #[inline(always)]
