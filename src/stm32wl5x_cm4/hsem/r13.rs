///Register `R13` reader
pub struct R(crate::R<R13_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<R13_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<R13_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<R13_SPEC>) -> Self {
        R(reader)
    }
}
///Register `R13` writer
pub struct W(crate::W<R13_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<R13_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<R13_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<R13_SPEC>) -> Self {
        W(writer)
    }
}
...
///
///For information about available fields see [r13](index.html) module
pub struct R13_SPEC;
impl crate::RegisterSpec for R13_SPEC {
    type Ux = u32;
}
///`read()` method returns [r13::R](R) reader structure
impl crate::Readable for R13_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [r13::W](W) writer structure
impl crate::Writable for R13_SPEC {
    type Writer = W;
}
///`reset()` method sets R13 to value 0
impl crate::Resettable for R13_SPEC {
    #[inline(always)]
