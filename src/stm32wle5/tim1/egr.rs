...
pub type B2G_W<'a, const O: u8> = crate::BitWriter<'a, u32, EGR_SPEC, B2G_AW, O>;
...
pub type BG_W<'a, const O: u8> = crate::BitWriter<'a, u32, EGR_SPEC, BG_AW, O>;
...
pub type COMG_W<'a, const O: u8> = crate::BitWriter<'a, u32, EGR_SPEC, COMG_AW, O>;
