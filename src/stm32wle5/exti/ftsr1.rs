...
///Field `FT21` reader - Falling trigger event configuration bit of Configurable Event input
pub type FT21_R = FT0_R;
///Field `FT21` writer - Falling trigger event configuration bit of Configurable Event input
pub struct FT21_W<'a> {
    w: &'a mut W,
}
impl<'a> FT21_W<'a> {
...
///Field `FT22` reader - Falling trigger event configuration bit of Configurable Event input
pub type FT22_R = FT0_R;
///Field `FT22` writer - Falling trigger event configuration bit of Configurable Event input
pub struct FT22_W<'a> {
    w: &'a mut W,
}
impl<'a> FT22_W<'a> {
...
///Field `FT0` reader - Falling trigger event configuration bit of Configurable Event input
...
///Field `FT1` reader - Falling trigger event configuration bit of Configurable Event input
pub type FT1_R = FT0_R;
///Field `FT1` writer - Falling trigger event configuration bit of Configurable Event input
pub struct FT1_W<'a> {
    w: &'a mut W,
}
impl<'a> FT1_W<'a> {
...
///Field `FT2` reader - Falling trigger event configuration bit of Configurable Event input
pub type FT2_R = FT0_R;
///Field `FT2` writer - Falling trigger event configuration bit of Configurable Event input
pub struct FT2_W<'a> {
    w: &'a mut W,
}
impl<'a> FT2_W<'a> {
...
///Field `FT3` reader - Falling trigger event configuration bit of Configurable Event input
pub type FT3_R = FT0_R;
///Field `FT3` writer - Falling trigger event configuration bit of Configurable Event input
pub struct FT3_W<'a> {
    w: &'a mut W,
}
impl<'a> FT3_W<'a> {
...
///Field `FT4` reader - Falling trigger event configuration bit of Configurable Event input
pub type FT4_R = FT0_R;
///Field `FT4` writer - Falling trigger event configuration bit of Configurable Event input
pub struct FT4_W<'a> {
    w: &'a mut W,
}
impl<'a> FT4_W<'a> {
...
///Field `FT5` reader - Falling trigger event configuration bit of Configurable Event input
pub type FT5_R = FT0_R;
///Field `FT5` writer - Falling trigger event configuration bit of Configurable Event input
pub struct FT5_W<'a> {
    w: &'a mut W,
}
impl<'a> FT5_W<'a> {
...
///Field `FT6` reader - Falling trigger event configuration bit of Configurable Event input
pub type FT6_R = FT0_R;
///Field `FT6` writer - Falling trigger event configuration bit of Configurable Event input
pub struct FT6_W<'a> {
    w: &'a mut W,
}
impl<'a> FT6_W<'a> {
...
///Field `FT7` reader - Falling trigger event configuration bit of Configurable Event input
pub type FT7_R = FT0_R;
///Field `FT7` writer - Falling trigger event configuration bit of Configurable Event input
pub struct FT7_W<'a> {
    w: &'a mut W,
}
impl<'a> FT7_W<'a> {
...
///Field `FT8` reader - Falling trigger event configuration bit of Configurable Event input
pub type FT8_R = FT0_R;
///Field `FT8` writer - Falling trigger event configuration bit of Configurable Event input
pub struct FT8_W<'a> {
    w: &'a mut W,
}
impl<'a> FT8_W<'a> {
...
///Field `FT9` reader - Falling trigger event configuration bit of Configurable Event input
pub type FT9_R = FT0_R;
///Field `FT9` writer - Falling trigger event configuration bit of Configurable Event input
pub struct FT9_W<'a> {
    w: &'a mut W,
}
impl<'a> FT9_W<'a> {
...
///Field `FT10` reader - Falling trigger event configuration bit of Configurable Event input
pub type FT10_R = FT0_R;
///Field `FT10` writer - Falling trigger event configuration bit of Configurable Event input
pub struct FT10_W<'a> {
    w: &'a mut W,
}
impl<'a> FT10_W<'a> {
...
///Field `FT11` reader - Falling trigger event configuration bit of Configurable Event input
pub type FT11_R = FT0_R;
///Field `FT11` writer - Falling trigger event configuration bit of Configurable Event input
pub struct FT11_W<'a> {
    w: &'a mut W,
}
impl<'a> FT11_W<'a> {
...
///Field `FT12` reader - Falling trigger event configuration bit of Configurable Event input
pub type FT12_R = FT0_R;
///Field `FT12` writer - Falling trigger event configuration bit of Configurable Event input
pub struct FT12_W<'a> {
    w: &'a mut W,
}
impl<'a> FT12_W<'a> {
...
///Field `FT13` reader - Falling trigger event configuration bit of Configurable Event input
pub type FT13_R = FT0_R;
///Field `FT13` writer - Falling trigger event configuration bit of Configurable Event input
pub struct FT13_W<'a> {
    w: &'a mut W,
}
impl<'a> FT13_W<'a> {
...
///Field `FT14` reader - Falling trigger event configuration bit of Configurable Event input
pub type FT14_R = FT0_R;
///Field `FT14` writer - Falling trigger event configuration bit of Configurable Event input
pub struct FT14_W<'a> {
    w: &'a mut W,
}
impl<'a> FT14_W<'a> {
...
///Field `FT15` reader - Falling trigger event configuration bit of Configurable Event input
pub type FT15_R = FT0_R;
///Field `FT15` writer - Falling trigger event configuration bit of Configurable Event input
pub struct FT15_W<'a> {
    w: &'a mut W,
}
impl<'a> FT15_W<'a> {
...
///Field `FT16` reader - Falling trigger event configuration bit of Configurable Event input
pub type FT16_R = FT0_R;
///Field `FT16` writer - Falling trigger event configuration bit of Configurable Event input
pub struct FT16_W<'a> {
    w: &'a mut W,
}
impl<'a> FT16_W<'a> {
