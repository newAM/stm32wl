...
///Field `TXEIE` reader - Transmit data register empty/TXFIFO not full interrupt enable
...
///Field `TXEIE` writer - Transmit data register empty/TXFIFO not full interrupt enable
...
///Field `RXNEIE` writer - Receive data register not empty/RXFIFO not empty interrupt enable
