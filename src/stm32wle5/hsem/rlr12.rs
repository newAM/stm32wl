///Register `RLR12` reader
pub struct R(crate::R<RLR12_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RLR12_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RLR12_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RLR12_SPEC>) -> Self {
        R(reader)
    }
}
...
///
///For information about available fields see [rlr12](index.html) module
pub struct RLR12_SPEC;
impl crate::RegisterSpec for RLR12_SPEC {
    type Ux = u32;
}
///`read()` method returns [rlr12::R](R) reader structure
impl crate::Readable for RLR12_SPEC {
    type Reader = R;
}
///`reset()` method sets RLR12 to value 0
impl crate::Resettable for RLR12_SPEC {
    #[inline(always)]
