///Register `R12` reader
pub struct R(crate::R<R12_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<R12_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<R12_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<R12_SPEC>) -> Self {
        R(reader)
    }
}
///Register `R12` writer
pub struct W(crate::W<R12_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<R12_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<R12_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<R12_SPEC>) -> Self {
        W(writer)
    }
}
...
///
///For information about available fields see [r12](index.html) module
pub struct R12_SPEC;
impl crate::RegisterSpec for R12_SPEC {
    type Ux = u32;
}
///`read()` method returns [r12::R](R) reader structure
impl crate::Readable for R12_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [r12::W](W) writer structure
impl crate::Writable for R12_SPEC {
    type Writer = W;
}
///`reset()` method sets R12 to value 0
impl crate::Resettable for R12_SPEC {
    #[inline(always)]
