///Register `R10` reader
pub struct R(crate::R<R10_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<R10_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<R10_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<R10_SPEC>) -> Self {
        R(reader)
    }
}
///Register `R10` writer
pub struct W(crate::W<R10_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<R10_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<R10_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<R10_SPEC>) -> Self {
        W(writer)
    }
}
...
///
///For information about available fields see [r10](index.html) module
pub struct R10_SPEC;
impl crate::RegisterSpec for R10_SPEC {
    type Ux = u32;
}
///`read()` method returns [r10::R](R) reader structure
impl crate::Readable for R10_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [r10::W](W) writer structure
impl crate::Writable for R10_SPEC {
    type Writer = W;
}
///`reset()` method sets R10 to value 0
impl crate::Resettable for R10_SPEC {
    #[inline(always)]
