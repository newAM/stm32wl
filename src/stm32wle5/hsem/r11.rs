///Register `R11` reader
pub struct R(crate::R<R11_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<R11_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<R11_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<R11_SPEC>) -> Self {
        R(reader)
    }
}
///Register `R11` writer
pub struct W(crate::W<R11_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<R11_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<R11_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<R11_SPEC>) -> Self {
        W(writer)
    }
}
...
///
///For information about available fields see [r11](index.html) module
pub struct R11_SPEC;
impl crate::RegisterSpec for R11_SPEC {
    type Ux = u32;
}
///`read()` method returns [r11::R](R) reader structure
impl crate::Readable for R11_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [r11::W](W) writer structure
impl crate::Writable for R11_SPEC {
    type Writer = W;
}
///`reset()` method sets R11 to value 0
impl crate::Resettable for R11_SPEC {
    #[inline(always)]
