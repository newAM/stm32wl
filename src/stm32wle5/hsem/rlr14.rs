///Register `RLR14` reader
pub struct R(crate::R<RLR14_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RLR14_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RLR14_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RLR14_SPEC>) -> Self {
        R(reader)
    }
}
...
///
///For information about available fields see [rlr14](index.html) module
pub struct RLR14_SPEC;
impl crate::RegisterSpec for RLR14_SPEC {
    type Ux = u32;
}
///`read()` method returns [rlr14::R](R) reader structure
impl crate::Readable for RLR14_SPEC {
    type Reader = R;
}
///`reset()` method sets RLR14 to value 0
impl crate::Resettable for RLR14_SPEC {
    #[inline(always)]
