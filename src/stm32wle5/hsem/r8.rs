///Register `R8` reader
pub struct R(crate::R<R8_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<R8_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<R8_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<R8_SPEC>) -> Self {
        R(reader)
    }
}
///Register `R8` writer
pub struct W(crate::W<R8_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<R8_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<R8_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<R8_SPEC>) -> Self {
        W(writer)
    }
}
...
///
///For information about available fields see [r8](index.html) module
pub struct R8_SPEC;
impl crate::RegisterSpec for R8_SPEC {
    type Ux = u32;
}
///`read()` method returns [r8::R](R) reader structure
impl crate::Readable for R8_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [r8::W](W) writer structure
impl crate::Writable for R8_SPEC {
    type Writer = W;
}
///`reset()` method sets R8 to value 0
impl crate::Resettable for R8_SPEC {
    #[inline(always)]
