///Register `RLR9` reader
pub struct R(crate::R<RLR9_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RLR9_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RLR9_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RLR9_SPEC>) -> Self {
        R(reader)
    }
}
...
///
///For information about available fields see [rlr9](index.html) module
pub struct RLR9_SPEC;
impl crate::RegisterSpec for RLR9_SPEC {
    type Ux = u32;
}
///`read()` method returns [rlr9::R](R) reader structure
impl crate::Readable for RLR9_SPEC {
    type Reader = R;
}
///`reset()` method sets RLR9 to value 0
impl crate::Resettable for RLR9_SPEC {
    #[inline(always)]
