///Register `RLR13` reader
pub struct R(crate::R<RLR13_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RLR13_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RLR13_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RLR13_SPEC>) -> Self {
        R(reader)
    }
}
...
///
///For information about available fields see [rlr13](index.html) module
pub struct RLR13_SPEC;
impl crate::RegisterSpec for RLR13_SPEC {
    type Ux = u32;
}
///`read()` method returns [rlr13::R](R) reader structure
impl crate::Readable for RLR13_SPEC {
    type Reader = R;
}
///`reset()` method sets RLR13 to value 0
impl crate::Resettable for RLR13_SPEC {
    #[inline(always)]
