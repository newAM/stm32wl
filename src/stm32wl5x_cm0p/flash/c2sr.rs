...
pub type EOP_W<'a, const O: u8> = crate::BitWriter<'a, u32, C2SR_SPEC, EOP_AW, O>;
...
pub type OPERR_W<'a, const O: u8> = crate::BitWriter<'a, u32, C2SR_SPEC, OPERR_AW, O>;
...
pub type PROGERR_W<'a, const O: u8> = crate::BitWriter<'a, u32, C2SR_SPEC, PROGERR_AW, O>;
...
pub type WRPERR_W<'a, const O: u8> = crate::BitWriter<'a, u32, C2SR_SPEC, WRPERR_AW, O>;
...
pub type PGAERR_W<'a, const O: u8> = crate::BitWriter<'a, u32, C2SR_SPEC, PGAERR_AW, O>;
...
pub type SIZERR_W<'a, const O: u8> = crate::BitWriter<'a, u32, C2SR_SPEC, SIZERR_AW, O>;
...
pub type PGSERR_W<'a, const O: u8> = crate::BitWriter<'a, u32, C2SR_SPEC, PGSERR_AW, O>;
...
pub type MISSERR_W<'a, const O: u8> = crate::BitWriter<'a, u32, C2SR_SPEC, MISSERR_AW, O>;
...
pub type FASTERR_W<'a, const O: u8> = crate::BitWriter<'a, u32, C2SR_SPEC, FASTERR_AW, O>;
...
pub type RDERR_W<'a, const O: u8> = crate::BitWriter<'a, u32, C2SR_SPEC, RDERR_AW, O>;
