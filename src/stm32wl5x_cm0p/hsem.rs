...
pub mod c1misr;
///C2IER register accessor: an alias for `Reg<C2IER_SPEC>`
pub type C2IER = crate::Reg<c2ier::C2IER_SPEC>;
///HSEM Interrupt enable register
pub mod c2ier;
///C2ICR register accessor: an alias for `Reg<C2ICR_SPEC>`
...
///HSEM Interrupt status register
pub mod c2isr;
///C2MISR register accessor: an alias for `Reg<C2MISR_SPEC>`
