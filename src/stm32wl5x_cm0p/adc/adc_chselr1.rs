...
///`read()` method returns [adc_chselr1::R](R) reader structure
impl crate::Readable for ADC_CHSELR1_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [adc_chselr1::W](W) writer structure
impl crate::Writable for ADC_CHSELR1_SPEC {
    type Writer = W;
}
///`reset()` method sets ADC_CHSELR1 to value 0
