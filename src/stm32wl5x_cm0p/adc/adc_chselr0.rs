...
///`read()` method returns [adc_chselr0::R](R) reader structure
impl crate::Readable for ADC_CHSELR0_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [adc_chselr0::W](W) writer structure
impl crate::Writable for ADC_CHSELR0_SPEC {
    type Writer = W;
}
///`reset()` method sets ADC_CHSELR0 to value 0
