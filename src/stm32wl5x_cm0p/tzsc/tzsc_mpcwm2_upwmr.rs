///Register `TZSC_MPCWM2_UPWMR` reader
...
///Register `TZSC_MPCWM2_UPWMR` writer
...
///`read()` method returns [tzsc_mpcwm2_upwmr::R](R) reader structure
impl crate::Readable for TZSC_MPCWM2_UPWMR_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [tzsc_mpcwm2_upwmr::W](W) writer structure
impl crate::Writable for TZSC_MPCWM2_UPWMR_SPEC {
    type Writer = W;
}
///`reset()` method sets TZSC_MPCWM2_UPWMR to value 0x0fff_0000
