...
pub struct RegisterBlock {
    ...
    ///0x50 - option register 1
    pub or1: crate::Reg<or1::OR1_SPEC>,
    ///0x54 - capture/compare mode register 3
    ...
    ///0x68 - timer input selection register
...
///option register 1
pub mod or1;
///CCMR3_Output register accessor: an alias for `Reg<CCMR3_OUTPUT_SPEC>`
...
pub mod af1;
///AF2 register accessor: an alias for `Reg<AF2_SPEC>`
