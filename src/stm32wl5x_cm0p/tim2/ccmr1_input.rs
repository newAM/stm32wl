...
pub type IC2F_A = IC1F_A;
///Field `IC2F` reader - Input capture 2 filter
pub type IC2F_R = IC1F_R;
...
pub type IC2PSC_A = IC1PSC_A;
///Field `IC2PSC` reader - Input capture 2 prescaler
pub type IC2PSC_R = IC1PSC_R;
...
impl<'a> IC2PSC_W<'a> {
    ///Writes `variant` to the field
    #[inline(always)]
    pub fn variant(self, variant: IC2PSC_A) -> &'a mut W {
        self.bits(variant.into())
    }
    ///CCx channel is configured as output
    #[inline(always)]
    pub fn output(self) -> &'a mut W {
        self.variant(IC2PSC_A::OUTPUT)
    }
    ///Capture is done once every 2 events
    #[inline(always)]
    pub fn capture2(self) -> &'a mut W {
        self.variant(IC2PSC_A::CAPTURE2)
    }
    ///Capture is done once every 4 events
    #[inline(always)]
    pub fn capture4(self) -> &'a mut W {
        self.variant(IC2PSC_A::CAPTURE4)
    }
    ///Capture is done once every 8 events
    #[inline(always)]
    pub fn capture8(self) -> &'a mut W {
        self.variant(IC2PSC_A::CAPTURE8)
    }
    ///Writes raw bits to the field
    #[inline(always)]
    pub fn bits(self, value: u8) -> &'a mut W {
