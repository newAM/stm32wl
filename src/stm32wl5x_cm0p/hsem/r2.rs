...
///Register `R2` writer
pub struct W(crate::W<R2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<R2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<R2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<R2_SPEC>) -> Self {
        W(writer)
    }
}
...
///`read()` method returns [r2::R](R) reader structure
impl crate::Readable for R2_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [r2::W](W) writer structure
impl crate::Writable for R2_SPEC {
    type Writer = W;
}
