///Register `RLR15` reader
pub struct R(crate::R<RLR15_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RLR15_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RLR15_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RLR15_SPEC>) -> Self {
        R(reader)
    }
}
...
///
///For information about available fields see [rlr15](index.html) module
pub struct RLR15_SPEC;
impl crate::RegisterSpec for RLR15_SPEC {
    type Ux = u32;
}
///`read()` method returns [rlr15::R](R) reader structure
impl crate::Readable for RLR15_SPEC {
    type Reader = R;
}
///`reset()` method sets RLR15 to value 0
impl crate::Resettable for RLR15_SPEC {
    #[inline(always)]
