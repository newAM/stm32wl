///Register `R9` reader
pub struct R(crate::R<R9_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<R9_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<R9_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<R9_SPEC>) -> Self {
        R(reader)
    }
}
///Register `R9` writer
pub struct W(crate::W<R9_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<R9_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<R9_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<R9_SPEC>) -> Self {
        W(writer)
    }
}
...
///
///For information about available fields see [r9](index.html) module
pub struct R9_SPEC;
impl crate::RegisterSpec for R9_SPEC {
    type Ux = u32;
}
///`read()` method returns [r9::R](R) reader structure
impl crate::Readable for R9_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [r9::W](W) writer structure
impl crate::Writable for R9_SPEC {
    type Writer = W;
}
///`reset()` method sets R9 to value 0
impl crate::Resettable for R9_SPEC {
    #[inline(always)]
