///Register `R7` reader
pub struct R(crate::R<R7_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<R7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<R7_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<R7_SPEC>) -> Self {
        R(reader)
    }
}
///Register `R7` writer
pub struct W(crate::W<R7_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<R7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<R7_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<R7_SPEC>) -> Self {
        W(writer)
    }
}
...
///
///For information about available fields see [r7](index.html) module
pub struct R7_SPEC;
impl crate::RegisterSpec for R7_SPEC {
    type Ux = u32;
}
///`read()` method returns [r7::R](R) reader structure
impl crate::Readable for R7_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [r7::W](W) writer structure
impl crate::Writable for R7_SPEC {
    type Writer = W;
}
///`reset()` method sets R7 to value 0
impl crate::Resettable for R7_SPEC {
    #[inline(always)]
