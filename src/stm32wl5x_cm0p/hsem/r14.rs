///Register `R14` reader
pub struct R(crate::R<R14_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<R14_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<R14_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<R14_SPEC>) -> Self {
        R(reader)
    }
}
///Register `R14` writer
pub struct W(crate::W<R14_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<R14_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<R14_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<R14_SPEC>) -> Self {
        W(writer)
    }
}
...
///
///For information about available fields see [r14](index.html) module
pub struct R14_SPEC;
impl crate::RegisterSpec for R14_SPEC {
    type Ux = u32;
}
///`read()` method returns [r14::R](R) reader structure
impl crate::Readable for R14_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [r14::W](W) writer structure
impl crate::Writable for R14_SPEC {
    type Writer = W;
}
///`reset()` method sets R14 to value 0
impl crate::Resettable for R14_SPEC {
    #[inline(always)]
