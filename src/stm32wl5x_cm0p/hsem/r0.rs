...
///Register `R0` writer
pub struct W(crate::W<R0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<R0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<R0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<R0_SPEC>) -> Self {
        W(writer)
    }
}
...
///`read()` method returns [r0::R](R) reader structure
impl crate::Readable for R0_SPEC {
    type Reader = R;
}
///`write(|w| ..)` method takes [r0::W](W) writer structure
impl crate::Writable for R0_SPEC {
    type Writer = W;
}
