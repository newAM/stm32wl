///Register `RLR10` reader
pub struct R(crate::R<RLR10_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RLR10_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RLR10_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RLR10_SPEC>) -> Self {
        R(reader)
    }
}
...
///
///For information about available fields see [rlr10](index.html) module
pub struct RLR10_SPEC;
impl crate::RegisterSpec for RLR10_SPEC {
    type Ux = u32;
}
///`read()` method returns [rlr10::R](R) reader structure
impl crate::Readable for RLR10_SPEC {
    type Reader = R;
}
///`reset()` method sets RLR10 to value 0
impl crate::Resettable for RLR10_SPEC {
    #[inline(always)]
