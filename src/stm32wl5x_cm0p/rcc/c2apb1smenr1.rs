...
pub use TIM2SMEN_A as LPTIM1SMEN_A;
#[doc = "DAC1 clock enable during CPU2 CSleep mode."]
pub use TIM2SMEN_A as DAC1SMEN_A;
#[doc = "I2C3 clock enable during CPU2 CSleep and CStop modes"]
pub use TIM2SMEN_A as I2C3SMEN_A;
#[doc = "I2C2 clock enable during CPU2 CSleep and CStop modes"]
pub use TIM2SMEN_A as I2C2SMEN_A;
#[doc = "I2C1 clock enable during CPU2 CSleep and CStop modes"]
pub use TIM2SMEN_A as I2C1SMEN_A;
#[doc = "USART2 clock enable during CPU2 CSleep mode."]
pub use TIM2SMEN_A as USART2SMEN_A;
#[doc = "SPI2S2 clock enable during CPU2 CSleep mode."]
pub use TIM2SMEN_A as SPI2S2SMEN_A;
#[doc = "RTC bus clock enable during CPU2 CSleep mode."]
pub use TIM2SMEN_A as RTCAPBSMEN_A;
